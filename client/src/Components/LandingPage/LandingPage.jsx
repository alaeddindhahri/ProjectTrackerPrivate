            ...
            <div className="row">
              <div className="col-lg-4">
                <div className="about-box about-light text-center p-3">
                  ...
                  <p className="text-muted f-14">
                    Easily add your projects alongside their details. Request validation in a blink of an eye
                  </p>
                </div>
              </div>
              {/* <!-- col end --> */}
              ...
              <div className="col-lg-4">
                <div className="about-box about-light text-center p-3">
                  ...
                  <p className="text-muted f-14">
                    Have a God eye on your assigned projects. See how your students are progressing in real time.
                  </p>
                </div>
              </div>
              {/* <!-- col end --> */}
              ...
              <div className="col-lg-4">
                <div className="about-box about-light text-center p-3">
                  ...
                  <p className="text-muted f-14">
                    Manage both your students and instructors. Keep an eye on your stats.
                  </p>
                </div>
              </div>
              {/* <!-- col end --> */}
              ...
              <div className="col-lg-4 col-md-6">
                <div className="service-box rounded mt-4 p-4">
                  ...
                  <div className="services-desc">
                    ...
                    <p className="text-muted mb-3 f-14">
                      Check your statistics and plan accordingly.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="service-box rounded mt-4 p-4">
                  ...
                  <div className="services-desc">
                    ...
                    <p className="text-muted mb-3 f-14">
                      Control your organization's entitities. From instructors to students and their projects
                    </p>
                  </div>
                </div>
              </div>
